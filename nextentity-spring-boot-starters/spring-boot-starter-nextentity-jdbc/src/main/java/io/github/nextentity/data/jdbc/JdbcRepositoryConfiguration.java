...
import static io.github.nextentity.data.jdbc.NextEntityJdbcAutoConfiguration.JDBC_REPOSITORY_FACTORY_BEAN_NAME;

@Configuration
@Import(NextEntityJdbcAutoConfiguration.class)
public class JdbcRepositoryConfiguration {
    ...
    Repository<ID, T> jdbcRepository(DependencyDescriptor descriptor,
                                     @Qualifier(JDBC_REPOSITORY_FACTORY_BEAN_NAME)
