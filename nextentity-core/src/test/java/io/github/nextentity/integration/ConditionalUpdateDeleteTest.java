...
public class ConditionalUpdateDeleteTest {
    ...
    void shouldUpdateSingleFieldWithWhereCondition(IntegrationTestContext context) {
        ...
        int updated = context.getUpdateExecutor().update(Employee.class)
    ...
    void shouldUpdateAllRecordsWhenNoWhereCondition(IntegrationTestContext context) {
        // Given - 先创建一些独立的测试数据
        context.getUpdateExecutor().insert(createTestEmployee(9010L, "Bulk 1", "bulk1@example.com"), Employee.class);
        context.getUpdateExecutor().insert(createTestEmployee(9011L, "Bulk 2", "bulk2@example.com"), Employee.class);
        context.getUpdateExecutor().insert(createTestEmployee(9012L, "Bulk 3", "bulk3@example.com"), Employee.class);
    ...
    void shouldUpdateWithNumericComparisonConditions(IntegrationTestContext context) {
        ...
        context.getUpdateExecutor().insert(lowSalaryEmployee, Employee.class);

        Employee highSalaryEmployee = createTestEmployee(9021L, "High Salary", "high@example.com");
        highSalaryEmployee.setSalary(100000.0);
        context.getUpdateExecutor().insert(highSalaryEmployee, Employee.class);
    ...
    void shouldUpdateDepartmentFields(IntegrationTestContext context) {
        ...
        // When
        int updated = context.getUpdateExecutor().update(Department.class)
    ...
    void shouldDeleteWithSingleWhereCondition(IntegrationTestContext context) {
        ...
        // When
        int deleted = context.getUpdateExecutor().delete(Employee.class)
    ...
    void shouldDeleteWithMultipleWhereConditions(IntegrationTestContext context) {
        // Given - 创建多个测试员工
        context.getUpdateExecutor().insert(createTestEmployee(9110L, "Delete Multi 1", "dm1@example.com"), Employee.class);
        context.getUpdateExecutor().insert(createTestEmployee(9111L, "Delete Multi 2", "dm2@example.com"), Employee.class);
        Employee toDelete = createTestEmployee(9112L, "Delete Multi 3", "dm3@example.com");
        toDelete.setStatus(EmployeeStatus.INACTIVE);
        context.getUpdateExecutor().insert(toDelete, Employee.class);
    ...
    void shouldDeleteMultipleRecordsWithInCondition(IntegrationTestContext context) {
        // Given
        context.getUpdateExecutor().insert(createTestEmployee(9120L, "Batch Delete 1", "bd1@example.com"), Employee.class);
        context.getUpdateExecutor().insert(createTestEmployee(9121L, "Batch Delete 2", "bd2@example.com"), Employee.class);
        context.getUpdateExecutor().insert(createTestEmployee(9122L, "Batch Delete 3", "bd3@example.com"), Employee.class);
    ...
    void shouldDeleteWithNumericComparisonCondition(IntegrationTestContext context) {
        ...
        context.getUpdateExecutor().insert(lowSalary, Employee.class);

        Employee highSalary = createTestEmployee(9131L, "High Salary Keep", "hsk@example.com");
        highSalary.setSalary(100000.0);
        context.getUpdateExecutor().insert(highSalary, Employee.class);
    ...
    void shouldDeleteWithNullCondition(IntegrationTestContext context) {
        ...
        context.getUpdateExecutor().insert(nullEmailEmployee, Employee.class);

        Employee normalEmployee = createTestEmployee(9141L, "Normal Email", "normal@example.com");
        context.getUpdateExecutor().insert(normalEmployee, Employee.class);
    ...
    void shouldDeleteWithNotNullCondition(IntegrationTestContext context) {
        ...
        context.getUpdateExecutor().insert(nullEmail, Employee.class);

        Employee normalEmail = createTestEmployee(9151L, "Normal Email", "normal@example.com");
        context.getUpdateExecutor().insert(normalEmail, Employee.class);
    ...
    void shouldUpdateThenDeleteInTransaction(IntegrationTestContext context) {
        // Given
        context.getUpdateExecutor().insert(createTestEmployee(9200L, "Combined 1", "c1@example.com"), Employee.class);
        context.getUpdateExecutor().insert(createTestEmployee(9201L, "Combined 2", "c2@example.com"), Employee.class);
